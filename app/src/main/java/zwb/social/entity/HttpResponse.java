package zwb.social.entity;

import java.util.HashMap;
import java.util.Map;

import zwb.social.config.HttpConstants;
import zwb.social.util.HttpUtils;
import zwb.social.util.StringUtils;
import zwb.social.util.TimeUtils;
 ...
 * <li>{@link zwb.social.entity.HttpResponse#HttpResponse()}</li>
 * <li>{@link zwb.social.entity.HttpResponse#HttpResponse(String)}</li>
 * </ul>
 * <ul>
 * <strong>Get</strong>
