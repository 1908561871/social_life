...
import zwb.social.config.HttpConstants;
import zwb.social.entity.HttpRequest;
import zwb.social.entity.HttpResponse;
 ...
 * <li>{@link #httpGet(HttpRequest, zwb.social.util.HttpUtils.HttpListener)} http get asynchronous</li>
 * <li>{@link #httpGet(String, zwb.social.util.HttpUtils.HttpListener)} http get asynchronous</li>
 * </ul>
 * <ul>
...
public class HttpUtils {
     ...
     * @param httpUrl
     * @return the response of the url, if null represents http error
     * @see zwb.social.util.HttpUtils#httpGet(HttpRequest)
     */
     ...
     * @param httpUrl
     * @return the response of the url, if null represents http error
     * @see zwb.social.util.HttpUtils#httpPost(HttpRequest)
     */
     ...
     *        {@link zwb.social.util.HttpUtils#joinParas(java.util.Map)}
     * @return the content of the url, if null represents http error
     * @see zwb.social.util.HttpUtils#httpPost(HttpRequest)
     */
